...
{color=FF0000}S{/color} и \
{color=FF0000}D{/color} можно перемещать камеру.
Клавишами \
{color=FF0000}-{/color} и \
{color=FF0000}+{/color} - уменьшать и увеличивать масштаб.
...
Вкладка <Свойства> позволяет редактировать места.
	...
	Для добавления нового места:
		1. Клик по кнопке <Добавить Место>,
...
{color=FF0000}-{/color} и \
{color=FF0000}+{/color} работают точно так же.
