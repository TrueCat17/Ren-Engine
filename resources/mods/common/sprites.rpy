init -1000:
	...
	image photo ren = im.matrix_color('images/sprites/rn/happy.png', im.matrix.saturation(0)):
		zoom 0.5
	image photo room = im.matrix_color('images/bg/room.jpg', im.matrix.colorize('#FF0', '#08F')):
		zoom 0.33
