...
Также стоит отметить компактность (17 МБ против 100), скорость запуска, потребление памяти и отсутствие подвисаний.
...
На данный момент движок перешёл на Python3.14.  
...
Also compactness (17 MB vs 100), speed of start, intake of memory and miss of hangs.
...
At the moment, the engine has switched to Python3.14.  
