...
for i in os.listdir(sources_path):
	if os.path.isdir(sources_path + i) and i.startswith('SDL2-'):
		
		shutil.copytree(sources_path + i + '/include', inc_path + 'SDL2')
		break
else:
	print('SDL2 sources not found')


for i in os.listdir(sources_path):
	if os.path.isdir(sources_path + i) and i.startswith('SDL2_image'):
		shutil.copyfile(sources_path + i + '/SDL_image.h', inc_path + 'SDL2/SDL_image.h')
		break
else:
	print('SDL2_image sources not found')


for i in os.listdir(sources_path):
	if os.path.isdir(sources_path + i) and i.startswith('SDL2_ttf'):
		shutil.copyfile(sources_path + i + '/SDL_ttf.h', inc_path + 'SDL2/SDL_ttf.h')
		break
else:
	print('SDL2_ttf sources not found')
